...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/img/edit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.openLogPushButton.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/img/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deleteLogPushButton.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/img/change.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.changeLogPushButton.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/img/refresh.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.reloadConfButton.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/img/folder.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.confSelectButton.setIcon(icon4)
        ...
        self.docSelectButton.setIcon(icon4)
