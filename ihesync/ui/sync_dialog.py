...
# Form implementation generated from reading ui file 'ihesync\ui\sync_dialog.ui'
#
...
class Ui_SyncDialog(object):
    def setupUi(self, SyncDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/3_books.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
